      ...
      <div className='contacts-body__list__card'>
        ...
        <div className="contacts-body__list__card__controls">
            ...
            {this.props.isContactPage && 
              <button  className="contacts-body__list__card__controls__button" onClick={() => this.props.swapUser(this.props.userId)}>
            ...
            {!this.props.isContactPage && 
              <button  className="contacts-body__list__card__controls__button contacts-body__list__card__controls__button_filled" onClick={() => this.props.swapUser(this.props.userId)}>
                ADD TO CONTACTS
              </button>
            }
